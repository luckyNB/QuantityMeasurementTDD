...
public class QuantityMeasurementTest {
    ...
    public void given0feetAnd0feetIfEqual_ShouldReturnTrue() {
        ConverterOfUnits feet1 = new ConverterOfUnits(ConvertUnits.ConvertUnit.FEET,0.0);
        ConverterOfUnits feet2 = new ConverterOfUnits(ConvertUnits.ConvertUnit.FEET,0.0);
    ...
    public void given0feetAnd1FeetValues_ShouldReturnFalse() {
        ConverterOfUnits feet1 = new ConverterOfUnits(ConvertUnits.ConvertUnit.FEET,0.0);
        ConverterOfUnits feet2 = new ConverterOfUnits(ConvertUnits.ConvertUnit.FEET,1.0);
        Assert.assertNotEquals(feet1, feet2);
    }

    @Test
    public void givenOneNUllValueShouldReturnFalse() {
        ConverterOfUnits feet1 = new ConverterOfUnits(ConvertUnits.ConvertUnit.FEET,3.0);
        feet1.equals(null);
    ...
    public void given0InchAnd0InchIfEqual_ShouldReturnTrue() {
        ConverterOfUnits inch1 = new ConverterOfUnits(ConvertUnits.ConvertUnit.INCHES,0.0);
        ConverterOfUnits inch2 = new ConverterOfUnits(ConvertUnits.ConvertUnit.INCHES,0.0);
    ...
    public void givenDifferentInchValues_ShouldReturnFalse() {
        ConverterOfUnits inch1 = new ConverterOfUnits(ConvertUnits.ConvertUnit.INCHES,0.0);
        ConverterOfUnits inch2 = new ConverterOfUnits(ConvertUnits.ConvertUnit.INCHES,1.0);
        Assert.assertNotEquals(inch1, inch2);
    }

    @Test
    public void given1FeetAnd1Inch_ShouldReturnFalse() {
        ConverterOfUnits inch1 = new ConverterOfUnits(ConvertUnits.ConvertUnit.INCHES,1.0);
        ConverterOfUnits feet1 = new ConverterOfUnits(ConvertUnits.ConvertUnit.FEET,1.0);
    ...
    public void given0InchAnd0Feet_ShouldReturnEqual() {
        ConverterOfUnits feet1 = new ConverterOfUnits(ConvertUnits.ConvertUnit.FEET, 0.0);
        ConverterOfUnits inches1 = new ConverterOfUnits(ConvertUnits.ConvertUnit.INCHES, 0.0);
    ...
    public void given1InchAnd1Feet_ShouldReturnNotEqual() {
        ConverterOfUnits feet1 = new ConverterOfUnits(ConvertUnits.ConvertUnit.FEET, 1.0);
        ConverterOfUnits inches1 = new ConverterOfUnits(ConvertUnits.ConvertUnit.INCHES, 1.0);
        boolean check = feet1.compareCheck(inches1);
    ...
    public void given1feetAnd1inchIfNotEqual_ShouldReturnFalse() {
        ConverterOfUnits feet = new ConverterOfUnits(ConvertUnits.ConvertUnit.FEET, 1.0);
        ConverterOfUnits inch = new ConverterOfUnits(ConvertUnits.ConvertUnit.INCHES, 1.0);
    ...
    public void given1feetAnd12inches_ShouldReturnTrue() {
        ConverterOfUnits feet = new ConverterOfUnits(ConvertUnits.ConvertUnit.FEET, 1.0);
        ConverterOfUnits inch = new ConverterOfUnits(ConvertUnits.ConvertUnit.INCHES, 12.0);
        boolean compareCheck = feet.compareCheck(inch);
    ...
    public void given12InchesAnd1Feet_ShouldReturnTrue() {
        ConverterOfUnits inches = new ConverterOfUnits(ConvertUnits.ConvertUnit.INCHES,12);
        ConverterOfUnits feet = new ConverterOfUnits(ConvertUnits.ConvertUnit.FEET, 1.0);
    ...
    public void given3FeetAnd12Inch_ShouldReturnFalse() {
        ConverterOfUnits inches = new ConverterOfUnits(ConvertUnits.ConvertUnit.INCHES, 12.0);
        ConverterOfUnits feet = new ConverterOfUnits(ConvertUnits.ConvertUnit.FEET,3.0);
        boolean compareCheck = inches.compareCheck(feet);
        Assert.assertFalse(compareCheck);
    }
    ...
    public void given0YardAnd0Yard_ShouldReturnTrue() {
        ConverterOfUnits yard1 = new ConverterOfUnits(ConvertUnits.ConvertUnit.YARD, 0.0);
        ConverterOfUnits yard2 = new ConverterOfUnits(ConvertUnits.ConvertUnit.YARD, 0.0);
    ...
    public void given0yardAnd1yardValues_ShouldReturnFalse() {
        ConverterOfUnits yard1 = new ConverterOfUnits(ConvertUnits.ConvertUnit.YARD,0.0);
        ConverterOfUnits yard2 = new ConverterOfUnits(ConvertUnits.ConvertUnit.YARD,1.0);
        Assert.assertNotEquals(yard1, yard2);
    }

    @Test
    public void givenOneNUllValueForYardUnitShouldReturnFalse() {
        ConverterOfUnits yard1 = new ConverterOfUnits(ConvertUnits.ConvertUnit.YARD,3.0);
        yard1.equals(null);
        Assert.assertFalse(false);
    }
    ...
    public void given3feetAnd1yard_ShouldReturnTrue() {
        ConverterOfUnits feet = new ConverterOfUnits(ConvertUnits.ConvertUnit.FEET, 3);
        ConverterOfUnits yard = new ConverterOfUnits(ConvertUnits.ConvertUnit.YARD, 1);
    ...
    public void given1inchAnd1yard_ShouldReturnFalse() {
        ConverterOfUnits inches = new ConverterOfUnits(ConvertUnits.ConvertUnit.INCHES, 1);
        ConverterOfUnits yard = new ConverterOfUnits(ConvertUnits.ConvertUnit.YARD, 1);
    ...
    public void given1yardAnd36inch_ShouldReturnTrue() {
        ConverterOfUnits yard = new ConverterOfUnits(ConvertUnits.ConvertUnit.YARD, 1);
        ConverterOfUnits inches = new ConverterOfUnits(ConvertUnits.ConvertUnit.INCHES, 36);
    ...
    public void given2inchAnd5cm_ShouldReturnTrue() {
        ConverterOfUnits inch = new ConverterOfUnits(ConvertUnits.ConvertUnit.INCHES, 2);
        ConverterOfUnits cm = new ConverterOfUnits(ConvertUnits.ConvertUnit.CM,5);
    ...
    public void given2inchesAnd2inches_ShouldReturnAddition4inches() {
        ConverterOfUnits inch1 = new ConverterOfUnits(ConvertUnits.ConvertUnit.INCHES, 2);
        ConverterOfUnits inch2 = new ConverterOfUnits(ConvertUnits.ConvertUnit.INCHES, 2);
    ...
    public void given1feetAnd1feet_ShouldReturnAddition24inches() {
        ConverterOfUnits feet1 = new ConverterOfUnits(ConvertUnits.ConvertUnit.FEET, 1);
        ConverterOfUnits feet2 = new ConverterOfUnits(ConvertUnits.ConvertUnit.FEET, 1);
    ...
    public void given2inchAnd2dot5cm_ShouldReturnAddition3inches() {
        ConverterOfUnits inch = new ConverterOfUnits(ConvertUnits.ConvertUnit.INCHES, 2);
        ConverterOfUnits cm = new ConverterOfUnits(ConvertUnits.ConvertUnit.CM, 2.5);
    ...
    public void given1gallonAnd3dot78litres_ShouldReturnTrue() {
        ...
        ConverterOfUnits litre = new ConverterOfUnits(ConvertUnits.ConvertUnit.LITRE, 3.78);
